...
},
{
  ...
  caraPengolahan: [
    {
      idPengolahan: 'olah-4',
      teks: 'Kerupuk panggang dari kulit apel. Cara membuat: Campur kulit apel dengan mentega cair dan gula kayu manis. Panggang hingga kecoklatan dan matang.',
      idUser: 'user-4',
      namaLengkap: 'Udin',
...
},
{
  ...
  caraPengolahan: [
    {
      idPengolahan: 'olah-7',
      teks: 'Masker dari ampas teh hijau. Cara membuat: Ambil dua kantong teh hijau bekas. Keluarkan ampas teh. Tambahkan 2-4 sendok makan madu dan sedikit jus lemon. Oleskan pada wajah dan tunggu 5-10 menit. Bilas dengan air hangat. Gunakan masker ini sekali atau dua kali seminggu.',
      idUser: 'user-7',
      namaLengkap: 'Dinda',
      createdAt: '',
    },
...
},
{
  ...
  caraPengolahan: [
    {
      idPengolahan: 'olah-8',
      teks: 'Keripik wortel. Cara membuat: Iris tipis kulit wortel. Panggang di oven hingga kering. Tambahkan sedikit minyak zaitun dan rempah-rempah untuk rasa yang lebih menarik.',
      idUser: 'user-8',
      namaLengkap: 'Budi',
      createdAt: '',
    },
...
},
{
  ...
  caraPengolahan: [
    {
      idPengolahan: 'olah-9',
      teks: 'Babutuk dari ikan busuk. Cara membuat: Buang isi perut ikan, rebus ikan busuk besar dan buang tulangnya. Haluskan bumbu: kunir, laos, sereh, kemiri, garam, asam daun kalamenyu, lombok merah, santan, dan gula. Campurkan bumbu dengan daging ikan. Rebus sambil diaduk hingga air mengering. Tambahkan daun asam kalamenyu saat hampir matang. Hasil akhir seperti abon basah.',
      idUser: 'user-9',
      namaLengkap: 'Kelvin',
      createdAt: '',
    },
...
},
{
  ...
  caraPengolahan: [
    {
      idPengolahan: 'olah-11',
      teks: 'Keripik kulit bawang. Cara membuat: Cuci bersih kulit bawang, keringkan. Letakkan dalam wadah untuk memanggang. Tambahkan olive oil dan sedikit garam, aduk rata. Panggang selama 10 menit pada suhu 200°C hingga renyah. Gunakan sebagai camilan atau topping.',
      idUser: 'user-11',
      namaLengkap: 'Dilan',
      createdAt: '',
    },
...
},
{
  ...
  caraPengolahan: [
    {
      idPengolahan: 'olah-12',
      teks: 'Pembersih alami dari kulit jeruk. Cara membuat: Simpan kulit jeruk dalam toples kaca. Isi dengan cuka putih dan biarkan selama dua minggu. Saring cairannya. Campur air dengan cuka, perbandingan 2:1. Tuangkan ke dalam botol semprot untuk pembersih alami. Sisa kulit jeruk bisa dijadikan pupuk kompos.',
      idUser: 'user-12',
      namaLengkap: 'Nanda',
      createdAt: '',
    },
